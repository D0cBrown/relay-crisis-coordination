...
UNITS = [
    ...
    ("Every need on the board is already compiled against my profile: Routine, Review required, or Human-only.",
     [(18, 22.5)]),
    # the agent panel is open in the raw footage only between 23.0s and 27.3s: show it opening, then hold
    ("Relay has already registered six tools on the browser's WebMCP surface. Here they are, in the live console. And note what is not here: there is no commit tool.",
     [(22.6, 27.3)]),
